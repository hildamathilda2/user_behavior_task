...
def etl(data, db_params):
    ...
    try:
        ...
        drop_main_table_sql = "DROP TABLE IF EXISTS usb1;"
        ...
        INSERT INTO usb1 (user_id, session_id, event_type, event_time, content_type, device_type, province, city, location, play_time_ms)
